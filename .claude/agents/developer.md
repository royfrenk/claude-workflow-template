...
| Production | `main` | Product Owner only |

**This is non-negotiable.** If anyone asks you to push to `main`, refuse and escalate to the Product Owner.
...
2. API routes (if backend changes)
3. Components
4. Page integration
5. Tests
...
```bash
# Type checking (adjust for your stack)
npm run build
...
- New code should have tests where appropriate
...
Verify deployment at the staging URL.
...
| Check | How |
|-------|-----|
| Page loads | Visit the affected routes |
| No console errors | Open browser DevTools |
| Expected behavior | Test the user flow |
...
- Copy existing patterns in the codebase
